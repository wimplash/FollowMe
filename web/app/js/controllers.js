...
//            },
            ...
            paths: {
                p1: {
                    ...
                    weight: 16,
                    latlngs: [
                        { lat: 40.73271, lng: -73.99818},
                        { lat: 40.72604, lng: -73.97856},
                        { lat: 40.72104, lng: -73.96856},
                        { lat: 40.71904, lng: -73.95856}
                    ]
                }
            },
            events: {
        ...
        $scope.markers.push({
            lat: 40.73192, lng: -73.97849,
            message: "Gas",
            icon: {iconUrl: 'img/gas.png',iconSize: [20,20]}
        })
        $scope.markers.push({
            lat: 40.73192, lng: -73.94849,
            message: "Hazard",
            icon: {iconUrl: 'img/hazard-small.png',iconSize: [20,20]}
        })
        $scope.markers.push({
            lat: 40.72192, lng: -73.93849,
            message: "Medic",
            icon: {iconUrl: 'img/medi-small.png',iconSize: [20,20]}
        })
        $scope.markers.push({
            lat: 40.73492, lng: -73.93849,
            message: "Mechanic",
            icon: {iconUrl: 'img/wrench-small.png',iconSize: [20,20]}
        })
